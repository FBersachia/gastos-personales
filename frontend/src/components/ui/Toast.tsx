...
export default function Toast({ id, message, type, duration = 3000, onClose }: ToastProps) {
  ...
  return (
    <div className={`flex items-center p-4 mb-3 border rounded-lg shadow-lg ${typeStyles[type]} animate-slide-in-right`}>
      <svg className="w-5 h-5 flex-shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
